...
(function() {
      ...
      fetch(apiUrl)
        ...
        .then(function(json) {
          json.results.forEach(function(item) {
            //in .results property, loop each item
            let pokemon = {
              //declare pokemon object with name and url key value pairs
              name: item.name,
              detailsUrl: item.url
            };
  ...
  function add(pokemon) {
    ...
    } else pokemonList.push(pokemon); //statement to add new pokemon item
  }
